 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://mail.javaops.ru/", wsdlLocation = "file:/C:/masterjava/services/mail-api/src/test/resources/wsdl/mailService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/masterjava/services/mail-api/src/test/resources/wsdl/mailService.wsdl");
