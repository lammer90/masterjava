...
--changeset plotnikov:1
CREATE TABLE post_results
(
  date_time    TIMESTAMP NOT NULL,
  addresses_to TEXT      NOT NULL,
  addresses_cc TEXT      NOT NULL,
  subject      TEXT      NOT NULL,
  text         TEXT      NOT NULL,
  CONSTRAINT post_results_date_time_addr UNIQUE (date_time, addresses_to)
);

CREATE INDEX post_results_date_time ON post_results (date_time);

--changeset plotnikov:2
