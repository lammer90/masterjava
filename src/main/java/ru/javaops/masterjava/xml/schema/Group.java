...
public class Group {
    ...
    public static class Users {
        ...
        @XmlElementRef(name = "user", namespace = "http://javaops.ru", type = JAXBElement.class, required = false)
        protected List<JAXBElement<Object>> user;
         ...
         * 
         */
        public List<JAXBElement<Object>> getUser() {
            if (user == null) {
                user = new ArrayList<JAXBElement<Object>>();
            }
            return this.user;
        }
